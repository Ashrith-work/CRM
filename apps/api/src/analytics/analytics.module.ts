...
@Module({
  ...
  providers: [AnalyticsService, RfmRefreshService, ChurnScoreService, TierService, SegmentService, AnalyticsProcessor],
  exports: [AnalyticsService, RfmRefreshService, ChurnScoreService, TierService, SegmentService],
})
